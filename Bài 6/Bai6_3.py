...
class Nguoi(object):
#Tạo lớp Nguoi (nghĩa là “Người”), là lớp cha (lớp cơ sở).
    def getGender(self):
    #Đây là một phương thức (hàm bên trong lớp) tên là getGender
        return "Unknown"
        #Phương thức này trả về chuỗi "Unknown" vì chưa biết là nam hay nữ.
class Nam(Nguoi):
