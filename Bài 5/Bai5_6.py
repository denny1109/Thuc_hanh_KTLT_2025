...
#Gọi hàm find_min() từ mô-đun mymodule để tìm giá trị nhỏ nhất trong danh sách lst
...
#Gọi hàm find_max_index để trả về để trả về vị trí của số lớn nhất.
min_index = mymodule.find_min_index(lst)
#Gọi hàm find_min_index để trả về để trả về vị trí của số nhỏ nhất.
# In kết quả
