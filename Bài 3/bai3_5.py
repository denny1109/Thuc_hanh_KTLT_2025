...
"""Giải thích: mặc dù đã khai báo biến toàn cục là Hello Guy nhưng khi khai bái hàm dùng 
lệnh global đã làm thay đổi biến cục bộ là Vinh University thành biến toàn cục thay cho Hello Guy"""