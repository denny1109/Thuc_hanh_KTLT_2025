...
class ATM:
#Tạo lớp ATM: Lớp này mô phỏng hoạt động của một máy ATM, bao gồm các chức năng như kiểm tra số dư, rút tiền, gửi tiền và xác thực mã PIN.
    def __init__(self):
    #Đây là hàm khởi tạo (__init__) của lớp ATM
        self.balance = 10000  
        #self.balance = 10000: Khởi tạo số dư tài khoản là 10,000 VND.
        self.pin = "1234" 
        #self.pin = "1234": Khởi tạo mã PIN mặc định là "1234". 
    def authenticate(self):
    # Phương thức authenticate này kiểm tra mã PIN của người dùng:
        ...
        while attempts > 0:
            ...
            #Nếu đúng, hiển thị "Mã PIN hợp lệ." và trả về True.
                print("Mã PIN hợp lệ.")
                return True
            else:
    ...
    #Phương thức check_balance sẽ in ra số dư tài khoản của người dùng.
        print(f"Số dư tài khoản của bạn là: {self.balance} VND")
    def withdraw(self):
    #Phương thức withdraw cho phép người dùng rút tiền:
        ...
        #Nếu số tiền rút nhỏ hơn hoặc bằng số dư hiện tại, thì cho phép rút tiền.
    ...
    def deposit(self):
    # Đây là định nghĩa một phương thức có tên deposit trong lớp ATM.Chức năng của nó là cho phép người dùng gửi thêm tiền vào tài khoản.
    ...
    def start(self):
    # Đây là định nghĩa một phương thức có tên start thuộc lớp ATM. Phương thức này đóng vai trò là điểm khởi đầu của chương trình, nơi người dùng bắt đầu tương tác với máy ATM.
